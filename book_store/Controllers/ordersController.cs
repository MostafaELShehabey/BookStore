...
namespace book_store.Controllers
{
    public class ordersController : Controller
    {
        ...
        public ordersController(book_storeContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.orders != null ? 
                          ...
                          Problem("Entity set 'book_storeContext.orders'  is null.");
        }
        ...
        public async Task<IActionResult> Create( int bookId,int quantity)
        {
            ...
            SqlConnection conn = new SqlConnection("Data Source=MR\\SQL2022;Initial Catalog=DatabaseForT_book;Integrated Security=True;Connect Timeout=30;Encrypt=False;Trust Server Certificate=False;Application Intent=ReadWrite;Multi Subnet Failover=False");
            string sql;
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'book_storeContext.orders'  is null.");
            }
            var orders = await _context.orders.FindAsync(id);
            if (orders != null)
            {
